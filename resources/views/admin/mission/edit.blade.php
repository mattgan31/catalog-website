                    ...
                    <div class="card-body">
                        ...
                        <form action="/admin/mission" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter the Title of Mission"
                                    name="mission_title" value="{{ $mission->mission_title }}">
                            </div>
                            <div class="form-group">
                                <label>Mission's Description</label>
                                <textarea type="file" class="form-control" placeholder="Describe the Mission" name="mission_description">{{ $mission->mission_description }}</textarea>
                            </div>
